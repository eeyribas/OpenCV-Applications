...
ret1, thresh1=cv2.threshold(grayImage, 70, 255, cv2.THRESH_BINARY_INV)
ret2, thresh2=cv2.threshold(grayImageCircle, 70, 255, cv2.THRESH_BINARY)
...
for contour in contours1:
    ...
    ret1=cv2.matchShapes(contours2[0], contour, cv2.CONTOURS_MATCH_I1, 0.0)
    ret2=cv2.matchShapes(contours2[0], contour, cv2.CONTOURS_MATCH_I2, 0.0)
    ret3=cv2.matchShapes(contours2[0], contour, cv2.CONTOURS_MATCH_I3, 0.0)
